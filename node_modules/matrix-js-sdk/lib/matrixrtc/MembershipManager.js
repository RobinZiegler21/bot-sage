...
export class MembershipManager extends TypedEventEmitter {
  ...
  get delayedLeaveEventRestartLocalTimeoutMs() {
    var _this$joinConfig$dela2, _this$joinConfig11;
    return (_this$joinConfig$dela2 = (_this$joinConfig11 = this.joinConfig) === null || _this$joinConfig11 === void 0 ? void 0 : _this$joinConfig11.delayedLeaveEventRestartLocalTimeoutMs) !== null && _this$joinConfig$dela2 !== void 0 ? _this$joinConfig$dela2 : 2000;
  }
  // LOOP HANDLER:
  ...
  restartDelayedEvent(delayId) {
    ...
    return _asyncToGenerator(function* () {
      var abortPromise = new Promise((_, reject) => {
        ...
        }, _this5.delayedLeaveEventRestartLocalTimeoutMs);
      });
